...
/*declare variables*/
extern atomic64_t counter;
extern atomic64_t duration;
...
static int __vmx_handle_exit(struct kvm_vcpu *vcpu, fastpath_t exit_fastpath)
{
	...
	//get current time, and increment counter, before each return, get the time and calculate duration
	...
	if (vmx->emulation_required) {
		atomic64_add(rdtsc() - start_time, &duration);
